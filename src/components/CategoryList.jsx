    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-6">
                <h4 className="text-xl font-bold text-gray-800 tracking-tight">Category
                    Sources</h4>
                <span
            ...
            {categories.length === 0 ? (
                <div
                    ...
                    <p className="text-gray-400 font-medium">No Categories added yet . Please
                        add some to View Here</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    {categories.map((category) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className="w-12 h-12 shrink-0 flex items-center justify-center rounded-xl bg-white shadow-sm border border-gray-100 group-hover:scale-110 transition-transform duration-300">
                                    <IconComponent
                                        size={22}
