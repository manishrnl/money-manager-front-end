        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div
                ...
                <div className="flex items-center gap-3">
                    <button
                        className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-600 text-sm font-semibold rounded-xl hover:bg-gray-50 transition-all active:scale-95">
                        <Mail size={16} className="text-indigo-500"/>
                        <span>Email</span>
                    </button>

                    <button
                        className="flex items-center gap-2 px-4 py-2 bg-emerald-50 border border-emerald-100 text-emerald-700 text-sm font-semibold rounded-xl hover:bg-emerald-100 transition-all active:scale-95">
